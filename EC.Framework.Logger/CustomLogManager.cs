...
namespace EC.Framework.Logger
{
    ...
    public class CustomLogManager
    {
        #region Members
        /// <summary>
        /// The wrapper map to use to hold the <see cref="CustomLogImpl"/> objects
        /// </summary>
        private static readonly WrapperMap m_WrapperMap = new WrapperMap(new WrapperCreationHandler(WrapperCreationHandler));
        #endregion
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static ICustomLog GetLogger(string domain, string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static ICustomLog GetLogger(Assembly assembly, string name)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static ICustomLog GetLogger(string domain, Type type)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static ICustomLog GetLogger(Assembly assembly, Type type)
        {
        ...
        private static ICustomLog WrapLogger(ILogger logger)
        {
            return (ICustomLog)m_WrapperMap.GetWrapper(logger);
        }
        ...
        {
            return new CustomLogImpl(logger);
        }
        #endregion Extension Handlers
    }
}