...
namespace EC.COM.Data
{
  ...
  public class VarInfoModelString
  {
    public string Annual_plan_priceS { get; set; }
    public string Non_employee_priceS { get; set; }
    public string Customers_priceS { get; set; }
    public string Onboarding_priceS { get; set; }
    public string Total_priceS { get; set; }
    public string CallCenterHotlineS { get; set; }

    public string TotalAnnualPriceS { get; set; }
    public string TwoYearPriceS { get; set; }
